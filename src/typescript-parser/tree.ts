...
function arrayToTree(ctx: Context, symbolStack: ts.Type[], type: ts.Type): nodes.Array {
...
function tupleToTree(ctx: Context, symbolStack: ts.Type[], type: ts.Type): nodes.Tuple {
...
function unionToTree(ctx: Context, symbolStack: ts.Type[], type: ts.UnionType): nodes.Node {
...
function objectToTree(ctx: Context, symbolStack: ts.Type[], type: ts.Type): nodes.Object {
    const properties: Record<string, nodes.Node> = {}
    const required: string[] = []
